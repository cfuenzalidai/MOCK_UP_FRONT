...
export default function Mapa({ bases = [], jugadores = [], planetas = [], naves = [], onTerritorioClick = null, selectingDestino = false }) {
  ...
  const up = ((r + c) % 2 === 0) !== flipRow;
      ...
      geometries.push({ ...t, pts, pointsStr, cx, cy, resourceColor, hasBase, base: baseMatch, casaId, esOrigen, originOwnerLabel, baseOwnerLabel, up, ships: shipsOnThis, territoryIndex });
    }
  }
